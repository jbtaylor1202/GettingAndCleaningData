...
#before running (do not set working directory to the extracted folder!)
...
#This was compelted before step 3 and 4 to allow the variables containing mean and standard deviation to be slected
